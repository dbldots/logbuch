  ...
  constructor: ->
    @_GLOBALS_DEFAULTS = {
      defaults: {
        ...
        ROLLBAR_SOURCEMAPS_URL_PREFIX: "https://logbuch.com"
      ...
      production: {
        ...
        # ANDROID_DEPLOY_APPBIN_PATH: "deploy@logbuch.com:/u/apps/ioniclogbuched/public/uploads/ionicstartlogbuchn.apk"
        # ANDROID_DEPLOY_APPBIN_URL: "http://logbuch.com/uploads/ioniclogbuchuction.apk"

        # If those 2 variables are defined, the app will be deployed to the remote server after compiling the release.
        # IOS_DEPLOY_APPBIN_PATH: "deploy@logbuch.com:/u/apps/ioniclogbuched/public/uploads/ionicstartlogbuchn.ipa"
        # IOS_DEPLOY_APPBIN_URL: "http://logbuch.com/uploads/ioniclogbuchuction.ipa"

        # Required for the release to be signed with correct certificate.
        IOS_PROVISIONING_PROFILE: "keys/ios/logbuchstaging.mobileprovision"

        # CORDOVA_GOOGLE_ANALYTICS_ID: "UA-123123-2"
        # GOOGLE_ANALYTICS_ID: "UA-123123-1"
        # GOOGLE_ANALYTICS_HOST: "logbuch.com"
      }
    }
